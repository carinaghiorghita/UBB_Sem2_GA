...
class UI():
    def __init__(self):
        ...
        n = int(line[0])
        m = int(line[1])
        self._serv=initGraph(n,m,DoubleListGraph,"graph2.txt")
    ...
    def printMenu(self):
        print("1.In degree of a given vertex\n"
              ...
              #"17.Find a Hamiltonian cycle of low cost (find MST and parse in preorder)\n"
              "17.Find a Hamiltonian cycle of low cost (using nearest neighbour algorithm)\n"
              "0.Exit\n")
    ...
    def start(self):
        ...
        while not validOption:
            ...
            while validOption:
                ...
                # elif opt=='17':
                #     tree=self._serv.graph.minTreePrim(0)
                #     cycle=self._serv.graph.preorderTree(0,tree)
                #     print("A Hamiltonian cycle of low cost is:")
                #     print(cycle)
                elif opt=='17':
                    cycle=[]
                    mincost=self._serv.graph.NNAlgorithm(0,cycle)
                    print("A Hamiltonian cycle of low cost is:")
                    print(cycle)
                    print("Cost:",mincost)
                else:
