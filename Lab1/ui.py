...
class UI():
    def __init__(self):
        ...
        n = int(line[0])
        m = int(line[1])
        self._serv=initGraph(n,m,DoubleListGraph,"graph1k.txt")
    ...
    def printMenu(self):
        print("1.In degree of a given vertex\n"
              ...
              "17.Find the connected components using a depth-first traversal of the graph\n"
              "0.Exit\n")
        ...
        while not validOption:
            ...
            while validOption:
                ...
                if opt=='0':
                    ...
                    allComps=connectedComponents(self._serv.graph)
